...
def get_data():
    ...
    compound_account = get_compounding_account()
    Cstarting_amount, Cinterest_rate, Cinterest_rate_time, Compound_period = compound_account[0], compound_account[1], compound_account[2], compound_account[3]
